...
| removeBlankRows        | NO       | false   | prune all blank rows from the CSV/dataMatrix output                                                                                                                                                                                                                            |
| removeBlankColumns     | NO       | false   | prune all blank columns from the CSV/dataMatrix output                                                                                                                                                                                                                         |
| removeInvisibleCells   | NO       | false   | when true, limit to only visible cells from Excel Sheet (i.e. row height > 0 and column width > 0)                                                                                                                                                                             |
