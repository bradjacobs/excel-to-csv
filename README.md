...
| removeBlankRows        | NO       | false   | remove out all blank rows from the Excel worksheet                                                                                                                                                                                                                             |
| removeBlankColumns     | NO       | false   | remove out all blank columns from the Excel worksheet                                                                                                                                                                                                                          |
| removeInvisibleCells   | NO       | false   | when true, limit to only visible cells (i.e. row height > 0 and column width > 0)                                                                                                                                                                                              |
