...
| charSanitizeFlags      | NO       | (SPACES,QUOTES) | optional character sanitization<br><br>*SPACES*: replace any unicode or abnormal space character with a normal space (i.e. nbsp)<br>*QUOTES*: replace any special single/double quotes with normal quotes (i.e. smart quotes)<br>*BASIC_DIACRITICS*: replace any diacritic characters with its basic counterpart (i.e. 'é' -> 'e', 'Ç' -> 'C') |
